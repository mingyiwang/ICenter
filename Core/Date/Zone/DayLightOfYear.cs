...
namespace Core.Date.Zone
{
    ...
    public sealed class DayLightOfYear
    {
        ...
        public static DayLightOfYear Of(DateTime dateTime)
        {
            ...
            return new DayLightOfYear(Date.Year.Of((int) local.Year), TimeZoneInfo.Local);
        }
        ...
        public static DayLightOfYear Of(DateTime dateTime, TimeZoneInfo zoneInfo)
        {
            ...
            return new DayLightOfYear(Date.Year.Of((int) zoneTime.Year), zoneInfo);
        }

        public static DayLightOfYear Of(DateTimeOffset dateTime)
        {
            return new DayLightOfYear(Date.Year.Of((int) dateTime.LocalDateTime.Year), TimeZoneInfo.Local);
        }
